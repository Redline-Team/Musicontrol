...
{
    /// <summary>
    /// Implementation of Apple Music player control for macOS.
    /// </summary>
    public class AppleMusicPlayer : MacOSMusicPlayerBase
    {
        ...
        /// </summary>
        public override string PlayerName => "Apple Music";

        /// <summary>
        /// Gets a value indicating whether the player is currently running.
        /// </summary>
        public override bool IsRunning => IsApplicationRunning("Music");
        ...
        public override bool IsPlaying
        {
            get
            {
                ...
                string script = "tell application \"Music\" to player state as string";
        ...
        public override void SetVolume(float volume)
        {
            if (IsRunning)
            {
                ...
                int appleMusicVolume = Mathf.RoundToInt(_volume * 100);
                ExecuteAppleScript($"tell application \"Music\" to set sound volume to {appleMusicVolume}");
            }
        }
        ...
        public override float GetVolume()
        {
            if (IsRunning)
            {
                string script = "tell application \"Music\" to sound volume as string";
                string result = ExecuteAppleScript(script);
        ...
        private void UpdateTrackInfo()
        {
            ...
            {
                Debug.LogError($"Error updating Apple Music track info: {ex.Message}");
            }
        }
    }
}
